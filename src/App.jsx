     ...
     <p>Loading...</p>
        ...
        */}
         <form onSubmit={sendNewPostRequest}>
          <label htmlFor="new-blog-title"> New Blog Title:</label>
          <input
          title="new-blog-title"
          type="text"
          placeholdeer="New blog title here"
          value={newPostTitle}
          onChange={(event) => {
        ...
        <label htmlFor="new-blog-body"> New Blog Here</label>
          <input
          title= "new-blog-body"
          type="text"
          placeholder="New blog here"
          value={newPostBody}
          onChange={(event) =>{
